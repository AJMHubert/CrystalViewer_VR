...
public class BuildingAtomsVer2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string[] lines = System.IO.File.ReadAllLines(@"C:\Users\Alex\New folder (2)\OneDrive - University of Warwick\Work\Software_Development\CrystalViewer_VR\Demo\Pb2ScTaO6-R3-a+a+a+-antiferro.cif");
